...
$(document).ready(function () {
    $("#txtTargetDescription").Editor();
    $("#lblTargetDescription").Editor();
...
TargetUtilities = {
    ...
    InsertTarget: function () {
        ...
        TargetViewModel.TargetDescription = $("#txtTargetDescription").Editor("getText");
    ...
    GetTargetByID: function (TargetID) {
        ...
        AjaxResult.success(function (data) {
            ...
            $("#lblTargetDescription").Editor("setText", data.targetDescription);
            ...
            $("#txtTargetDescription").Editor("setText", data.targetDescription);
    ...
    ClearTargetField: function () {
        ...
        $("#txtTargetName").val("");
        $("#txtTargetDescription").Editor("setText", "");
