...
ComplianceModuleUtilities = {
    ...
    InsertCompliance: function () {
        ...
        ComplianceModuleModel.Description = $("#txtDescription").Editor("getText");
    ...
    DeleteComplianceField: function (complianceID) {
        var confirmation = confirm("are you sure want to remove this compliance?");
        if (confirmation) {
            var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/Compliance/DeleteCompliance", "POST", { id: complianceID }, true);
            AjaxResult.success(function (data) {
                GeneralUtilities.ajaxindicatorstop();
                ComplianceModuleUtilities.GetComplianceList();
                $("#div1").removeClass("col-md-4").attr("class", "col-md-12 col-xs-12 col-sm-12");
    ...
    GetDragControlLibraries: function () {
        var activeSoAComplianceID = ComplianceModuleUtilities.getActiveSoAComplianceID();
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/Compliance/_DragControlLibraries", "GET", { activeSoAComplianceID: activeSoAComplianceID}, true);
        AjaxResult.success(function (data) {
    ...
    GetLibraryList: function () {
        var activeSoAComplianceID = ComplianceModuleUtilities.getActiveSoAComplianceID();
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/Compliance/_LibraryControlListTreeView", "GET", { activeSoAComplianceID: activeSoAComplianceID}, true);
        AjaxResult.success(function (data) {
            ...
            $("ul[sortid='sortable']").sortable({
                ...
                stop: function (event, ui) {
                    ...
                    var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/Compliance/AddDragLibrariesWithControls", "POST", { id: id, liType: liType, activeSoAComplianceID: activeSoAComplianceID }, false);
                        AjaxResult.success(function (data) {
                            GeneralUtilities.ajaxindicatorstop();
                            ComplianceModuleUtilities.GetDragControlLibraries();
                        });
    ...
    DeleteDragedControl: function (id, liType, activeSoAComplianceID) {
        debugger;
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/Compliance/DeleteDragedControl", "POST", { id: id, liType: liType, activeSoAComplianceID: activeSoAComplianceID }, true);
        AjaxResult.success(function (data) {
