function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        $BODY.hasClass("nav-md")
            ? ($MENU_TOGGLE.find('i').attr('class', 'fa fa-angle-double-right'), $SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($SIDEBAR_MENU.find("li.active-sm ul").show(), $MENU_TOGGLE.find('i').attr('class', 'fa fa-angle-double-left'), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"), a()
