...
CategoryUtilities = {
    ...
    GetCategoryByID: function (categoryId) {
        ...
        AjaxResult.success(function (data) {
            ...
            $("#txtCategoryDescription").Editor("setText",data.categoryDescription);  
    ...
    InsertCategory: function () {
        ...
        CategoryViewModel.CategoryDescription = $("#txtCategoryDescription").Editor("getText");
    ...
    ClearCategoryField: function () {
        $("#txtCategoryName").val("");
        $("#txtCategoryDescription").Editor("setText", "");  
