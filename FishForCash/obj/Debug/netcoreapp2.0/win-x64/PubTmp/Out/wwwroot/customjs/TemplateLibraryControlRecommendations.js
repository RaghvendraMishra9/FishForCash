...
ControlRecommendationUtilities = {
    ...
    GetSOARecommendationList: function (controlID) {
        ...
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/_SOARecommendationList", "GET", { complianceID: ComplianceID, libControlID: controlID }, true);
    ...
    GetLibraryControlInfo: function (controlID) {
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/GetLibraryControlById", "GET", { id: controlID }, true);
        AjaxResult.success(function (data) {
    ...
    InsertSOARecommendation: function () {
        ...
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/AddSOARecommendation", "POST", SOARecommendationModel, true);
        AjaxResult.success(function (data) {
            GeneralUtilities.ajaxindicatorstop();
            ControlRecommendationUtilities.ClearSOARecommendationField();
            $('#AddApplicabilityDiv').toggle();
...
ApplicabilityUtilities = {
    ...
    InsertSOAApplicability: function (libControlID) {
        ...
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/AddSOAApplicability", "POST", SOAApplicabilityModel, true);
        AjaxResult.success(function (data) {
            GeneralUtilities.ajaxindicatorstop();
    ...
    GetApplicabilityInfo: function (controlID) {
        ...
        var ComplianceID = ComplianceModuleUtilities.getActiveSoAComplianceID();
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/GetApplicabilityInfo", "GET", { complianceID: ComplianceID, libControlID: controlID }, true);
        AjaxResult.success(function (data) {
    ...
    ComplianceLevelDropdownList: function () {
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/ComplianceLevelDropdownList", "GET", {}, false);
        AjaxResult.success(function (data) {
...
LinkWithRecommendation = {
    GetSOALinkWithRecommendationList: function (controlId) {
        var ComplianceID = ComplianceModuleUtilities.getActiveSoAComplianceID();
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/_SOALinkWithRecommendationList", "GET", { complianceID: ComplianceID, libControlID: controlId }, true);
        AjaxResult.success(function (data) {
    ...
    InsertSOALinkWithRecommendation: function (libControlID, sOARecommendationID, RecommendationName, SOALinkWithRecommendationID)
    {
        ...
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/AddSOALinkWithRecommendation", "POST", SOALinkRecommendationModel, true);
        AjaxResult.success(function (data) {
            GeneralUtilities.ajaxindicatorstop();
            ControlRecommendationUtilities.ClearSOARecommendationField();
            $('#addSOARecommendation').hide();
    ...
    DeleteSOALinkWithRecommendation: function (linkwithrecommendationID) {
        ...
        if (confirmation) {
            var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/DeleteSOALinkWithRecommendation", "POST", { id: linkwithrecommendationID }, true);
            AjaxResult.success(function (data) {
                GeneralUtilities.ajaxindicatorstop();
    ...
    UpdateSOALinkWithRecommendation: function (sOARecommendationID, RecommendationName, SOALinkWithRecommendationID) {
        debugger
        var AjaxResult = GeneralUtilities.callajaxReturnSuccess("/TemplateSOA/UpdateLinkWithRecommendation", "POST", { sOARecommendationID: sOARecommendationID, RecommendationName: RecommendationName, SOALinkWithRecommendationID: SOALinkWithRecommendationID }, false);
        AjaxResult.success(function (data) {
            GeneralUtilities.ajaxindicatorstop();
        });
    },
